const Avatar = ({ user, width, height }) => {
  ...
  if (user.avatar) {
    ...
    return (
      <div
        className={`flex justify-center mx-1 bg-gray-400 w-10 h-10 rounded-full items-center text-lux-purple hover:scale-110 hover:translate-x-1 hover:-translate-y-0.5 duration-500`}
      >
